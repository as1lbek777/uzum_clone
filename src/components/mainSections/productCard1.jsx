      ...
      <motion.div className="flex flex-wrap gap-2.5">
        {limitedProducts.map((product) => (
          <div
            title={product.title}
            key={product.id}
            className="relative max-w-[240px] h-auto cursor-pointer transition-all rounded-[15px] hover:shadow-lg flex flex-col overflow-hidden z-10"
          >
            <motion.button
            ...
            <div className="p-2">
              ...
              <p className="mt-1 text-[#82899B] text-[12px] font-normal flex items-center gap-1">
              ...
              <div className="flex items-center justify-between mt-2.5">
                ...
                <div className="border border-[#ACADAD] p-1 rounded-[50%] transition-all hover:bg-[#e1dede]">
          ...
          <button className="">Yana ko'rsatish 10</button>
      </motion.div>
    </section>
  );
};
