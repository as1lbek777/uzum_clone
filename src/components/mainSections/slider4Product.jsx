...
const Slider4Product = () => {
  ...
  return (
    <section className="max-w-[1250px] m-auto pt-5">
      ...
      <div className="w-full h-[400px] mt-8 rounded-2xl overflow-hidden">
        <img
          src="https://images.uzum.uz/cu0fheei4n324lr3d4gg/main_page_banner.jpg"
          alt="This is a picture"
          className="w-full h-full object-cover hover:scale-[1.03] transition-all cursor-pointer"
        />
      </div>
    </section>
  );
