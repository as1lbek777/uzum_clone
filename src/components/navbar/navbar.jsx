...
const Navbar = () => {
  ...
  const languages = {
    uz: {
      label: "O'zbek tili",
      flag: "../../public/languageUz.png",
    },
    ru: {
      label: "Rus tili",
      flag: "../../public/languageRus.png",
    },
  };
      ...
      <nav className="relative">
        ...
        <div className="max-w-[1230px] m-auto pt-4 flex items-center gap-[52.41px]">
          <a href="#" className="flex items-center justify-center gap-1">
            <img
              className="w-7"
              src="../../src/assets/hafta-tovarlari.png"
        ...
        <div className="max-w-[1250px] mt-[-40px] m-auto">
          {katalog && (
            <motion.div
              variants={iconVariants}
              initial="initial"
            ...
            >
              <div className="bg-white w-[25%] h-auto pl-0 py-2.5 border-r-[#F1F1F2] border-r-2 px-2.5">
                <div className="flex items-center justify-between cursor-pointer hover:text-[#7F54FF] mb-2.5">
              ...
              <div className="flex items-center w-[950px] bg-white">
                <a href="#">vb</a>
              </div>
            </motion.div>
          )}
