...
const Navbar = () => {
  ...
  return (
    <nav className="relative">
      ...
      <div className="max-w-[1230px] m-auto pt-4 ml-8 flex items-center gap-[52.41px]">
          ...
          {mahsulotKategoriya.map((item, inx) => {
            return (
              <li key={inx}>
                <motion.a
                  href="#"
                  className="cursor-pointer text-wrapper font-normal text-[gray] hover:text-[#2a2929] transition-all"
                >
